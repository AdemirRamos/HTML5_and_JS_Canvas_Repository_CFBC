class Ball {
    ...
    resetarBola() {
        ...
        this.x = (this.context.canvas.width / 2) - (this.largura / 2)
        jogador.x = 0
        jogador.y = (this.context.canvas.height / 2) - (this.jogador.altura / 2)
        cpu.x = (this.context.canvas.width - this.cpu.largura)
        cpu.y = (this.context.canvas.height / 2) - (this.cpu.altura / 2)
    }
